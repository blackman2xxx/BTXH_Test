...
public class B1_GuiHoSo extends Init{
    ...
    public void SendProfile () throws InterruptedException{
        ...
        driver.navigate().to("https://dvcbtxh.molisa.gov.vnHome");
        ...
        js.executeScript("arguments[0].click()", driver.findElement(By.xpath("/html[1]/body[1]/main[1]/section[2]/div[1]/div[11]/div[3]/div[1]/input[1]")));
        Thread.sleep(1000);
        ...
        //tên
        driver.findElement(By.xpath("//input[@id='HoVaTen']")).sendKeys("Bùi Gia Bảo");

        //ngày sinh
        driver.findElement(By.xpath("//input[@id='NgayThangNamSinh']")).sendKeys("05/05/2005");
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("//span[@id='select2-HKTT_MaTinh-container']")).click();
        driver.findElement(By.xpath("/html/body/span/span/span[1]/input")).sendKeys("Cao Bằng");
        action.sendKeys(Keys.ENTER).build().perform();
