...
public class B13_CBhuyentoMChuyen extends Init {
    @Test
    public void B13_CBhuyentoMChuyen () throws InterruptedException {
        ...
        //tiếp nhận
        js.executeScript("arguments[0].click()", driver.findElement(By.xpath("//a[@href='/BTXH_ThongTinChung/HoSoCoKetQuaChoTiepNhan']")));
...
//        driver.findElement(By.xpath("//a[@href='/BTXH_ThongTinChung/HoSoCoKetQuaChoTiepNhan']")).click();
        ...
        //đăng xuất
        js.executeScript("arguments[0].click()", driver.findElement(By.xpath("//i[@class='topbar-icon pi pi-fw pi-user']")));
