...
public class B11_LDhuyentoUBhuyen extends Init {
    @Test
    public void Buoc11_LDhuyentoUBhuyen () throws InterruptedException {
        JavascriptExecutor js = (JavascriptExecutor)driver;
        driver.get("https://btxh.dttt.vn/");

        driver.findElement(By.xpath("//form[@class='login_form']//input[@id='UserName']")).sendKeys("352_ld");
